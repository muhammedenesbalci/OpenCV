...
# Transfer Images
path = "C:\\Users\\CASPER\\Desktop\\OpenCV\\MyCodes\\6.ConvolutionalNeuralNetworks\\DataCollecting\\images\\"
...
# convert list to an array because split operations
imagesList = np.array(imagesList)
print(imagesList, imagesList.shape, imagesList.size)
print(imagesList.shape[0])

# convert it to suitable format imagelist.shape direkt kaç resim olduğunu da yazabilrdik
imagesList = imagesList.reshape(imagesList.shape[0], width, height, 1) # count of channel last index is 1 we transfer images as gray scale
X = imagesList
