...
- Meanshift
* a clustering algorithm that iteratively assigns data points to clusters by shifting the points towards the mode
* so it's looking for the part with the highest mode
"""
...
# region of interest
roi = frame[face_y:face_y + h, face_x: face_x + w]  # inverse of the opencv or real (x, y) ground
