...
from max_supression import non_max_suppression
...
#%% download and import resnet5
print("Resnet yukleniyor")
model = ResNet50(weights = "imagenet", include_top = True) #imagenet yaparak ağırlıları korumasını sağlıyoruz, include_top outout layerini çıkarıyopr çünkü kendimiz ekleyceğiz
...
for label in labels.keys():
    ...
    plt.figure(), plt.imshow(clone), plt.title("ilk"), plt.show()
