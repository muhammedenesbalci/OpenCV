...
# Detect Contour
contours, hierarch = cv2.findContours(img, cv2.RETR_CCOMP, cv2.CHAIN_APPROX_SIMPLE)  # (img, find internal or external contours, give us the cordinates to corners)
